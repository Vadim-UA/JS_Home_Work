...
function getNewListOfObjects(arr) {
	let newArr = []
	for (const element of arr) {
		if (element.sell_status === 'available') {
			...
			newItem.old_price = element.old_price
			newItem.usd_price = element.usd_price
			newArr.push(newItem)
		}
	}
	return newArr
}
const newListOfObjects = getNewListOfObjects(dataList)
